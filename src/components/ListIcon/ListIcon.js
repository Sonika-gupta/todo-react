...
class ListIcon extends React.Component {
  ...
  render () {
    return (
      <div className='list' onContextMenu={this.handleIconClick}>
        <div key={this.props.list.id} className='list-icon-container'>
          ...
          <svg className={this.state.selected ? 'tick' : 'tick hidden'} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor'>
